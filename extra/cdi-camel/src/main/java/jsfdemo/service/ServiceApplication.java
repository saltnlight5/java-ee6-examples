...
import jsfdemo.services.camel.CamelService;
import jsfdemo.services.camel.MyTcpServerRoute;
...
public class ServiceApplication implements Service {
	...
	private Service createCamelService() {
		CamelService camelService = new CamelService();
		camelService.addCamelRoute(new MyTcpServerRoute());
		return camelService;
	}
}
